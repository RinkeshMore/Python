# -*- coding: utf-8 -*-
"""
Created on Fri Apr 28 22:06:53 2023
...
to_be_decoded = "Pnrfne pvcure? V zhpu cersre Pnrfne fnynq!"
cipher="AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz"
decipher="NnOoPpQqRrSsTtUuVvWwXxYyZzAaBbCcDdEeFfGgHhIiJjKkLlMm"

caesar_cipher = str.maketrans(cipher, decipher)

print(to_be_decoded.translate(caesar_cipher))
